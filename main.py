...
# Funktion zum Zählen der Übereinstimmungen von Wörtern in einem Text
def count_matches(word_list, text):
    return sum(1 for word in word_list if word in text)

# Funktion zum Extrahieren von Lateinischen Wörtern aus einer Textdatei
...
def main():
    ...
    # Lateinische Wörter extrahieren
